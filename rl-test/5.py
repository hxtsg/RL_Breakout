...
class DQN():
    ...
    # self.imageProcess.ShowImageFromNdarray( state_batch[0], 0 )
    # self.imageProcess.ShowImageFromNdarray( next_state_batch[0], 4 )
    #
    # cv2.waitKey(0)
    #
    #
    # def getRecentHistory_stack(self, state,
    #                            append_or_not):  # get the state from environment and return the stack of 80 *80 *4 state_in_shadow if cout >  SERIES_LENGTH
    #
    #     state_gray = self.imageProcess.ColorMat2B(state)
    #
    #     if append_or_not:
    ...
    #             ))
    #         # self.imageProcess.ShowImageFromNdarray( state_of_shadow, 1 )
    #         # cv2.waitKey(0)
    #         else:
    #             state_of_shadow = np.dstack((
    #                 self.recent_history_queue[-3],
    ...
    # def getRecentHistoryNext_stack(self, next_state): # get the state from next_state and return the 80 *80 *4
    ...
    def percieve(self, state_shadow, action_index, reward, state_shadow_next, done, time_step):
